...
router.post('/subscribe', function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    var decoded, notification, subscribtion, options, payload, err_1;
    return __generator(this, function (_a) {
        switch (_a.label) {
            ...
            case 1:
                decoded = _a.sent();
                return [4 /*yield*/, models_1.default.Push.create({
            ...
            case 2:
                ...
                connectWebPush_1.default.sendNotification(subscribtion, payload, options);
                if (!notification) {
...
router.post('/unsubscribe', function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                _a.trys.push([0, 2, , 3]);
                return [4 /*yield*/, models_1.default.Push.findOneAndRemove({
                        endpoint: req.body.endpoint,
                    })];
            case 1:
                _a.sent();
